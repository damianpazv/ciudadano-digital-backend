    ...
    try {
        ...
        if (user.length === 0) {
            const [result] = await connection.execute(
                ...
                [id_ciudadano, dni_ciudadano, nombre_ciudadano, email_ciudadano, clave_ciudadano, telefono_ciudadano, celular_ciudadano, domicilio, id_provincia, id_localidad, validado, fecha_carga, habilita]
            );
